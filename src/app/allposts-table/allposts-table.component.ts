...
@Component({
  standalone:true,
  imports:[CommonModule,RouterModule,MatButtonModule,MatTableModule,MatSidenavModule,RouterLink,ReactiveFormsModule,MatIconModule,MatDialogModule],
...
export class AllpostsTableComponent implements OnInit {
  ...
  constructor(private requestService:RequestServiceService,route:ActivatedRoute,public fb:FormBuilder,private matDialog:MatDialog){
